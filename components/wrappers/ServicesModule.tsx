              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground-500">
                      Understanding your business needs, defining project scope,
                      and creating a detailed roadmap.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground-500">
                      Building the application with clean, maintainable code and
                      thorough testing.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground-500">
                      Launching your application and providing ongoing support
                      and maintenance.
                    </p>
                  </div>
                </div>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-foreground-500">
                      Clean, well-documented, and maintainable code following
                      best practices.
                    </p>
                  </div>
                </li>
                ...
                <li className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-foreground-500">
                      Commitment to meeting deadlines and delivering projects on
                      schedule.
                    </p>
                  </div>
                </li>
                ...
                <li className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-foreground-500">
                      Continued support and maintenance after project
                      completion.
                    </p>
                  </div>
                </li>
