    ...
    return (
      <div className="section-padding">
        <div className="container-custom text-center">
          ...
          <p className="text-body mb-8">The project you're looking for doesn't exist or has been removed.</p>
          <Button 
            as={Link}
            to="/work"
            color="primary"
      ...
      <section className="pt-12 pb-6">
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-foreground-500 mb-6">Client: {project.client}</p>
                      ...
                      {project.kpis.map((kpi, index) => (
                        <div key={index} className="flex items-center gap-4">
                          <div className="w-12 h-12 rounded-full bg-primary-100 flex items-center justify-center flex-shrink-0">
                            <Icon icon={kpi.icon} className="text-primary" width={24} height={24} />
                          </div>
                          <div>
                            <p className="text-2xl font-bold text-primary">{kpi.value}</p>
                            <p className="text-sm text-foreground-500">{kpi.label}</p>
                          </div>
                        </div>
                      ))}
                    </div>
      ...
      <section className="py-12">
        <div className="container-custom">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div>
              <h2 className="heading-md mb-2">Interested in working together?</h2>
              <p className="text-foreground-500">Let's discuss how I can help with your next project.</p>
            </div>
