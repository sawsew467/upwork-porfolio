    ...
    return (
      <div className="section-padding">
        <div className="container-custom text-center">
          ...
          <p className="text-body mb-8">The blog post you're looking for doesn't exist or has been removed.</p>
          <Button 
            as={Link}
            to="/blog"
            color="primary"
              ...
              <div className="blog-content">
                <ReactMarkdown
                  ...
                  components={{
                    ...
                    p: ({ node, ...props }) => <p className="mb-4 text-foreground-600" {...props} />,
                    ...
                    code: ({ node, inline, ...props }) => 
                      inline ? (
                        <code className="bg-content2 px-1 py-0.5 rounded text-sm" {...props} />
                      ) : (
